          ...
          return (
            <div key={index} className="otherChat">
              ...
              <div className="otherChatBox">
                ...
                {/* 채팅 보낸 시각 */}
                <span className="otherChatTime">{String(msg.sendTime).split('T')[1].substring(0,5)}</span>
              </div>
            </div>
          );
        }
    ...
    return (
        <div className="PerChatRoom">
            <div className="ReceiverInfo">
                <img className="ProfileImg" src={chatRoom.receiverProfileImg}/>{chatRoom.receiverNickname}
            </div>
            <div className="Frame">
